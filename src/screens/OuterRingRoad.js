...
const OuterRingRoad = ({ navigation }) => {
    ...
    useEffect(() => {
        setBigImage(restaurantData[3].menu[0].photo)
        setSeletedPlotName(restaurantData[3].menu[0].name)
        setSeletedPlotPrice(restaurantData[3].menu[0].price)
        setSeletedPlotDescription(restaurantData[3].menu[0].description)
    }, [])
    ...
    return (
        <ImageBackground source={images.bg} style={styles.container}>
            <View style={{ marginTop: 22 }}>
                <Header title="Outer Ring Road" isHomeScreen navigation={navigation} />
            </View>
