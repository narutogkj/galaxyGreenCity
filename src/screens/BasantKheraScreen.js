...
const BasantKheraScreen = ({ navigation }) => {
    ...
    useEffect(() => {
        setBigImage(restaurantData[2].menu[0].photo)
        setSeletedPlotName(restaurantData[2].menu[0].name)
        setSeletedPlotPrice(restaurantData[2].menu[0].price)
        setSeletedPlotDescription(restaurantData[2].menu[0].description)
    }, [])
    ...
    return (
        <ImageBackground source={images.bg} style={styles.container}>
            <View style={{ marginTop: 22 }}>
                <Header title="Basant Khera" isHomeScreen navigation={navigation} />
            </View>
